  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        >
          Boomzy is a full-service performance marketing and conversion engineering agency. We connect paid media campaigns directly to your HubSpot or Salesforce pipeline, minimizing acquisition costs while driving qualified B2B pipeline growth and customer retention.
        </motion.p>
